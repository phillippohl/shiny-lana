...
public class MainComposite extends CustomComponent {
	...
	private void setupMenuBar() {
		...
		MenuBar.Command menuBarCommand_8 = new MenuBar.Command() {
		    public void menuSelected(MenuItem selectedItem) {
		    	setupTabSheet(7);
		    }  
		};
		...
		MenuBar.MenuItem menuBarItemSales = menuBar_1.addItem("Sales", null, menuBarCommand_8);
	...
	private void setupTabSheet(int selection) {
		...
		case 7:
			tab_1 = new VerticalLayout();
			tabSheet_1.addTab(tab_1, "Market");
			break;
		case 8:
			tab_1 = new VerticalLayout();
